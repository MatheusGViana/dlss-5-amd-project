# OptiScaler AMD PreSR Multipass v2.14 - NR scaling and upstream compatibility
...
## v2.14 reduced-scale correction
...
## v2.14 resolution transition handling
...
## v2.14 conservative reduced-scale composition
