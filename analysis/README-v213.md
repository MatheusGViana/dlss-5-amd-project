# OptiScaler AMD PreSR Multipass v2.13 - NR scaling and upstream compatibility
...
## v2.13 reduced-scale correction
...
## v2.13 resolution transition handling
...
## v2.13 conservative reduced-scale composition
